...
public class SqlMapClientImpl implements SqlMapClient, ExtendedSqlMapClient {
	...
	public SqlExecutor getSqlExecutor() {
		log.debug("SqlMapClientImpl.getSqlExecutor---->begin");
	...
	public PhysicalPaginatedList queryForPhysicalPaginatedList(String id, int pageNo, int pageSize, boolean allowCount) throws SQLException {
		return getLocalSqlMapSession().queryForPhysicalPaginatedList(id, pageNo, pageSize, allowCount);
	}
	...
	public PhysicalPaginatedList queryForPhysicalPaginatedList(String id, Object parameterObject, int pageNo, int pageSize, boolean allowCount) throws SQLException {
		return getLocalSqlMapSession().queryForPhysicalPaginatedList(id, parameterObject, pageNo, pageSize, allowCount);
	}
