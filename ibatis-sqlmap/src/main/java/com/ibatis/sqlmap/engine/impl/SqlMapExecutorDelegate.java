...
//import com.shtao.ext.ibatis.sqlmap.engine.mapping.statement.PhysicalPaginatedData;
import com.shtao.ext.ibatis.sqlmap.engine.mapping.statement.PhysicalPaginatedDataList;
...
public class SqlMapExecutorDelegate {
	...
	public void addMappedStatement(MappedStatement ms) {
		...
		//}
		//taotao modify 不判断键值重复问题，以最后的id为准
	...
	public SqlExecutor getSqlExecutor() {
		log.debug("SqlMapExecutorDelegate.getSqlExecutor------>begin");
		return sqlExecutor;
	}
	...
	// taotao add
	public PhysicalPaginatedList queryForPhysicalPaginatedList(SessionScope sessionScope, String id, Object paramObject, int pageNo, int pageSize,boolean allowCount) throws SQLException {
		return new PhysicalPaginatedDataList(sessionScope.getSqlMapExecutor(), id, paramObject, pageNo, pageSize,allowCount);
	}
