...
public class SqlMapSessionImpl implements SqlMapSession {
	...
	// taotao add
	// @Override
	//public PhysicalPaginatedList queryForPhysicalPaginatedList(String id, Object paramObject, int pageNo, int pageSize, boolean countable) throws SQLException {
	//	return delegate.queryForPhysicalPaginated(sessionScope, id, paramObject, pageNo, pageSize, countable);
	//}

	//@Override
	//public List queryForPhysicalPaginatedListData(String id, Object paramObject, int pageNo, int pageSize) throws SQLException {
	//	return delegate.queryForPhysicalPaginatedList(sessionScope, id, paramObject, pageNo, pageSize);
	//}

	//@Override
	//public int queryForPhysicalPaginatedTotalCount(String id, Object parameterObject) throws SQLException {
	//	return delegate.queryForPhysicalPaginatedCount(sessionScope, id, parameterObject);
	//}
	...
	@Override
	public PhysicalPaginatedList queryForPhysicalPaginatedList(String id, int pageNo, int pageSize,boolean allowCount) throws SQLException {
		return delegate.queryForPhysicalPaginatedList(sessionScope,null, id, pageNo, pageSize, allowCount);
	}

	@Override
	public PhysicalPaginatedList queryForPhysicalPaginatedList(String id, Object parameterObject, int pageNo, int pageSize,boolean allowCount) throws SQLException {
		return delegate.queryForPhysicalPaginatedList(sessionScope, id,parameterObject, pageNo, pageSize,allowCount);
	}
